...
// Description:   
// 1) original matrix A 출력
// 2) matrix A를 행과 열 바꾸어 출력
// 3) 0이 아닌 항만 "행 우선" 배열로 저장
// 4) 3의 결과물을 "열 우선" 배열로 저장
// 5) Fast transpose 이용하여 "열 우선" 배열로 저장
// Algorithm : 
// 1) matrix A를 hw1.txt에 저장 후 출력
// 2) 행렬 A,B를 나타내는 term a , term b 만들고 transpose 함수를 호출하여 A를 B로 바꾼다.
// 3) 행 기준으로 정렬 후 출력
// 4) 3의 결과물을 열 기준으로 정렬 후 출력
// 5) 3의 결과물을 ftranspose 함수 아용하여 열 가준으로 정렬 후 출력
// Variables: 
// int row : 행
// int col : 열
// int value : 데이터 값
// void original() : original matrix A 출력하는 함수
// void transpose() : A의 행 열 변환하는 함수
// void spares_row() : 행 우선 배열로 변환하는 함수
// void spares_col() : 열 우선 배열로 변환하는 함수
// void fast_col() : 열 우선 배열로 fast transpose 이용하여 변환하는 함수 
/////////////////////////////////////////////////////////////////
